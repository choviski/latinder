                    ...
                    <p class="mt-1"><b>Descrição: </b>{{$publicacao->animal->descricao}}</p>
                        ...
                        <div class="mt-3 pb-2 ">
                            <i class="far fa-heart fa-2x border border-primary rounded-circle p-2"
                               id="like{{$publicacao->id}}" onclick="like({{$publicacao->id}})"></i>
                            @foreach($interesses as $interesse)
                                @if($interesse->id_publicacao == $publicacao->id && $usuario->id == $interesse->id_usuario)
                                    <i class="fas fa-heart fa-2x border border-primary rounded-circle p-2"
                                       id="like{{$interesse->id}}" onclick="deslike({{$interesse->id}})"></i>
                                    <script>
                                        $("#like{{$publicacao->id}}").remove();
                                    </script>
                                @endif
                            @endforeach
                            <a  class="text-decoration-none text-dark" href="batepapo/{{$publicacao->id}}"><i
                            ...
                            <i class="far fa-comment-dots fa-2x border border-primary rounded-circle p-2"
                               ...
                               aria-expanded="false" aria-controls="collapseForm{{$publicacao->id}}"></i>
