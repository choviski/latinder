<?php $__env->startSection('content'); ?>
    <div class=" p-2 bg-light rounded shadow text-center">
        <form action="<?php echo e(route("usuario.store")); ?>" method="post" class="form-group ">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make(".layouts.iniciais", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\pogramas\latinder\resources\views/create.blade.php ENDPATH**/ ?>